...
<script>
	$(document).ready(function(){
        ...
        if ('WebSocket' in window){
			websocket = new WebSocket("ws://localhost:8080/springWs/ws?uid="+${sessionScope.uid});
		}else if('MozWebSocket' in window) {
			websocket = new MozWebSocket("ws://localhost:8080/springWs/ws"+${sessionScope.uid});
		}else{
			websocket = new SockJS("http://localhost:8080/springWs/ws/sockjs"+${sessionScope.uid});
		}
