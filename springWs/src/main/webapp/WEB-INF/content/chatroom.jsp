...
<script>
    $(document).ready(function(){
        ...
        var a=${sessionScope.uid};
        
        alert("入参:"+a);
        if ('WebSocket' in window) {
        	alert(1);
        	alert(a);
			websocket = new WebSocket("ws://10.0.1.183:8080/springWs/ws?uid="+a);
			alert("window");
		} else if ('MozWebSocket' in window) {
			alert(2);
			websocket = new MozWebSocket("ws://10.0.1.183:8080/springWs/ws"+a);
			alert("moz");
		} else {
			alert(3);
			websocket = new SockJS("http://10.0.1.183:8080/springWs/ws/sockjs"+a);
			alert("sockjs");
		}
